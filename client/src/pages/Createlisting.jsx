...
export default function CreateListing() {
    ...
    const storeImage = async (file) => {
        ...
        data.append('folder', 'sde-project/media'); // Updated folder name for cleanliness
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Re-used the old discount validation logic but applied to generic metrics
    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            <h1 className='text-3xl font-semibold text-center my-7'>Report an Issue</h1>
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{loading ? 'Submitting...' : 'Submit Issue Report'}</button>
